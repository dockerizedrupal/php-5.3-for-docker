...
class php {
  ...
  bash_exec { 'cp -r /tmp/php-5.3.29 /phpfarm/src/php-5.3.29':
  ...
  file { '/phpfarm/src/custom/options-5.3.29.sh':
    ...
    mode => 755,
    require => Bash_exec['cp -r /tmp/php-5.3.29 /phpfarm/src/php-5.3.29']
  }
  ...
  bash_exec { 'CP=1 && cp -r /tmp/php-5.3.29 /phpfarm/src/php-5.3.29':
  ...
  bash_exec { 'cp /src/build/modules/php/files/phpfarm/src/custom/options-5.3.29-fpm.sh /phpfarm/src/custom/options-5.3.29.sh':
    require => Bash_exec['CP=1 && cp -r /tmp/php-5.3.29 /phpfarm/src/php-5.3.29']
  }
