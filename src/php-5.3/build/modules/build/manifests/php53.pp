class build::php53 {
  require build::php53::packages
  require build::php53::supervisor
  require build::php53::logs
  ...
  bash_exec { 'cp /src/php-5.3/build/modules/build/files/usr/local/src/phpfarm/src/custom/options-5.3.29-fpm.sh /usr/local/src/phpfarm/src/custom/options-5.3.29.sh':
  ...
  bash_exec { 'PHPFPM=1 && /usr/local/src/phpfarm/src/main.sh 5.3.29':
    timeout => 0,
    require => Bash_exec['cp /src/php-5.3/build/modules/build/files/usr/local/src/phpfarm/src/custom/options-5.3.29-fpm.sh /usr/local/src/phpfarm/src/custom/options-5.3.29.sh']
  }
