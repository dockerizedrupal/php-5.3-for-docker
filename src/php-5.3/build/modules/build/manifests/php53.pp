class build::php53 {
  ...
  bash_exec { 'cp /src/-5.3/build/modules/build/files/usr/local/src/phpfarm/src/custom/options-5.3.29-fpm.sh /usr/local/src/phpfarm/src/custom/options-5.3.29.sh':
  ...
  bash_exec { 'PHPFPM=1 && /usr/local/src/phpfarm/src/main.sh 5.3.29':
    timeout => 0,
    require => Bash_exec['cp /src/-5.3/build/modules/build/files/usr/local/src/phpfarm/src/custom/options-5.3.29-fpm.sh /usr/local/src/phpfarm/src/custom/options-5.3.29.sh']
  }
