...
setup_drupal() {
  docker exec "$(container)" /bin/su - container -mc "wget http://ftp.drupal.org/files/projects/drupal-7.39.tar.gz -O /tmp/drupal-7.39.tar.gz"
  docker exec "$(container)" /bin/su - container -mc "tar xzf /tmp/drupal-7.39.tar.gz -C /tmp"
  docker exec "$(container)" /bin/su - container -mc "rsync -avz /tmp/drupal-7.39/ /apache/data"
